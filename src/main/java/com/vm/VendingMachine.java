...
public class VendingMachine {
	...
	{
		this.balance=this.balance.subtract(new BigDecimal(String.valueOf(this.balance)));
		message="$ refunding" + this.balance+ "\n Money in the machine is $"+this.balance.subtract(balance);
	}
	 ...
	 */
	public void reset(){
		message = START_UP_MESSAGE;
		balance = BigDecimal.ZERO;
		changeReturn = BigDecimal.ZERO;
	}
